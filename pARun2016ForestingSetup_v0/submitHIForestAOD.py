...
parser.add_option(      '--test'       ,dest='testSub',help='toggle test production setup', action="store_true")
...
inScript = "runForestAOD_pPb_DATA_80X.py"
